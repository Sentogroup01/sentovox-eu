...
themes:
  - id: "experience"
    icon: "🎭"
    label: "Esperienza visitatore"
  - id: "offerings"
    icon: "🏛"
    label: "Offerta & condizioni"
  - id: "demographics"
    icon: "👥"
    label: "Demografica"
  - id: "communication"
  ...
  - id: "nonvisitors"
    icon: "🚪"
    label: "Ex visitatori & non-visitatori"
  - id: "open"
    icon: "💬"
    label: "Feedback aperto"
  - id: "new"
    icon: "✨"
    label: "Nuovi strumenti"
...
theme_sections:
  ...
  - id: "demographics"
    ...
    body: |
      ...
      Tutti i dati di profilo possono essere incrociati con i punteggi di esperienza e soddisfazione.
  ...
  - id: "impact"
    ...
    items:
      ...
      - "Motivazione e nuove idee"
      - "Sviluppo delle competenze"

  - id: "nonvisitors"
    kicker: "Sviluppo del pubblico"
    title: "Ex visitatori & non-visitatori"
    teal: false
    body: |
      Perché le persone che visitavano in passato hanno smesso di venire? Perché altri non hanno mai visitato? SentoVox include domande specifiche per gli **ex visitatori** e i **non-visitatori**.

  - id: "open"
    kicker: "Feedback qualitativo"
    title: "Domande aperte e suggerimenti concreti"
    teal: true
    body: |
      I campi di testo aperto offrono ampio spazio per feedback qualitativo di alta qualità. I visitatori possono condividere suggerimenti concreti e commenti specifici.

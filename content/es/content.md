...
themes:
  - id: "experience"
    icon: "🎭"
    label: "Experiencia del visitante"
  - id: "offerings"
    icon: "🏛"
    label: "Oferta & condiciones"
  - id: "demographics"
    icon: "👥"
    label: "Demografía"
  - id: "communication"
...
theme_sections:
  ...
  - id: "demographics"
    ...
    body: |
      ...
      Todos los datos de perfil pueden cruzarse con las puntuaciones de experiencia y satisfacción.
  ...
  - id: "impact"
    ...
    items:
      ...
      - "Motivación y nuevas ideas"
      - "Desarrollo de habilidades"

  - id: "nonvisitors"
    kicker: "Desarrollo de audiencias"
    title: "Exvisitantes & no-visitantes"
    teal: false
    body: |
      ¿Por qué las personas que visitaban antes han dejado de venir? ¿Por qué otros nunca han visitado? SentoVox incluye preguntas específicas para **exvisitantes** y **no-visitantes**.

  - id: "open"
    kicker: "Feedback cualitativo"
    title: "Preguntas abiertas y sugerencias concretas"
    teal: true
    body: |
      Los campos de texto abierto proporcionan amplio espacio para feedback cualitativo de alta calidad. Los visitantes pueden compartir sugerencias concretas y comentarios específicos.
